...
function evaluateEfficiency(equipName) {
    ...
    if (gameResource.level > 11 && game.global.world != 200 && game.global.world > 37) {
        Res = 0;
        Wall = true;
    }
    return {
...
//        (game.global.mapBonus <= 1 && game.global.world >= 212 && game.global.world < 220) ||
        ...
        (game.global.mapBonus <= 8 && (game.global.world == 250 || game.global.world == 200 || game.global.world == 9251 || game.global.world == 9252 || game.global.world == 253 || game.global.world == 9254 || game.global.world == 255 || game.global.world == 9256 || game.global.world == 257 || game.global.world == 9258 || game.global.world == 259 || game.global.world == 260 || game.global.world == 2677 || game.global.world == 268 || game.global.world == 269 || game.global.world >= 270)) ||
