...
//        (game.global.mapBonus <= 1 && game.global.world >= 212 && game.global.world < 220) ||
        ...
        (game.global.mapBonus <= 8 && (game.global.world == 250 || game.global.world == 200 || game.global.world == 9251 || game.global.world == 9252 || game.global.world == 253 || game.global.world == 9254 || game.global.world == 255 || game.global.world == 9256 || game.global.world == 257 || game.global.world == 9258 || game.global.world == 9259 || game.global.world == 260)) ||
...
//        ((game.global.world == 9235 || game.global.world == 200) && game.global.lastClearedCell > 70 && ((new Date().getTime() - game.global.zoneStarted) / 1000 / 60) < 3) ||
        ((game.global.world == 253 || game.global.world == 9200) && game.global.lastClearedCell > 80 && ((new Date().getTime() - game.global.zoneStarted) / 1000 / 60) < 3.5) ||
