    ...
    if (unlockedHousing.length) {
        ...
        for (var best in keysSorted) {
            ...
            if (game.buildings[keysSorted[best]].owned < max || max == -1) {
                ...
                if ((WarpstationWall == true && bestBuilding == "Warpstation") || (game.global.world == 240 && game.buildings.Warpstation.owned >= 255))
...
//        (game.global.world > 240 && ((new Date().getTime() - game.global.mapStarted > 8000 && game.global.mapsActive) || game.global.mapBonus < 1)) ||
        ...
        ((game.global.world == 245 || game.global.world == 9200) && game.global.lastClearedCell > 80 && ((new Date().getTime() - game.global.zoneStarted) / 1000 / 60) < 4) ||
        ((game.global.world == 210 || game.global.world == 220 || game.global.world == 231 || game.global.world == 233 ||  game.global.world == 235 || game.global.world == 236 || game.global.world == 237 || game.global.world == 238 || game.global.world == 239 || game.global.world == 241 || game.global.world == 242 || game.global.world == 243 || game.global.world == 244) && game.global.mapBonus < 3) ||
