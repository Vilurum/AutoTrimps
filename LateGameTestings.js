        ...
        if (!gameResource.locked) {
            ...
            if (
                ...
                (
                    ...
                    ||
                    ((getPageSetting('BuyArmorUpgrades') && ((equipmentList[equipName].Resource != 'metal') || ((gameResource.prestige+2 <= ((game.global.world-5)/5)) || game.global.world > getPageSetting('VoidMaps')) || gameResource.prestige < 5) && (equipmentList[equipName].Stat == 'health'))
                        && 
