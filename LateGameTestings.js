...
function evaluateEfficiency(equipName) {
    ...
    if (10*Cos > NextCost && equip.Stat == 'attack' && game.global.world > 36) {
        Wall = true;
    }
    // a test - working
    if ((gameResource.prestige < ((game.global.world-10)/5)+2 && gameResource.level > 2) && (equip.Stat == 'attack') && game.global.world > 36) {
        Res = 0;
        Wall = true;
    }
    //not working 
    ...
    //    WarpstationWall = false;
    //}
    if (gameResource.prestige+1 < ((game.global.world-10)/5)+2 && gameResource.level > 0 && game.global.world > 36) {
        Res = 0;
        Wall = true;
    }
    if (gameResource.level > 11 && game.global.world != 200 && game.global.world > 36) {
        Res = 0;
        Wall = true;
    }
    return {
