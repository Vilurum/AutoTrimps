    ...
    if (unlockedHousing.length) {
        ...
        for (var best in keysSorted) {
            ...
            if (game.buildings[keysSorted[best]].owned < max || max == -1) {
                ...
                if ((WarpstationWall == true && bestBuilding == "Warpstation") || (game.global.world == 255 && game.buildings.Warpstation.owned >= 290))
...
//        (game.global.world > 240 && ((new Date().getTime() - game.global.mapStarted > 8000 && game.global.mapsActive) || game.global.mapBonus < 1)) ||
        ...
        ((game.global.world == 255 || game.global.world == 9200) && game.global.lastClearedCell > 80 && ((new Date().getTime() - game.global.zoneStarted) / 1000 / 60) < 5) ||
